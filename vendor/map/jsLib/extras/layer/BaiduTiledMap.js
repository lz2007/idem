...
dojo.provide("extras.layer.BaiduTiledMap");
dojo.require("esri.SpatialReference");
dojo.require("esri.layers.TiledMapServiceLayer");
dojo.require("esri.geometry.webMercatorUtils");

dojo.declare("extras.layer.BaiduTiledMap",[esri.layers.TiledMapServiceLayer],{
	online:false,
	mapStyle:"roadmap",
...
//        this.scale = [1981560944.88,990780472.44,495390236.22,247695118.11,123847559.06,61923779.53,30961889.76,
//                      15480944.88,7740472.44,3870236.22,1935518.11,967559.06,483779.53,241889.76,
//                      120944.88,60472.44,30236.22,15118.11,7559.06,3779.53];
//        this.resolution=[524288,262144,131072,65536,32768,16384,8192,4096,2048,1024,512,256,128,64,32,16,8,4,2,1];
    ...
    getTileUrl: function (level, row, col) { 
        ...
        if(this.online){
            if(this.mapStyle === "roadmap"){
            	url = "http://online"+num+".map.bdimg.com/tile/?qt=tile&x="+numX+"&y="+numY+"&z="+level+"&styles=pl&udt=20150928&scaler=1";
            }else if(this.mapStyle === "Image"){
            	url = "http://shangetu"+num+".map.bdimg.com/it/u=x="+numX+";y="+numY+";z="+level+";v=009;type=sate&fm=46&udt=20150601";
            }else if(this.mapStyle === "POI"){
            	url = "http://online"+num+".map.bdimg.com/tile/?qt=tile&x="+numX+"&y="+numY+"&z="+level+"&styles=sl&v=083&udt=20150815"
            }
        }else{
        	if(this.mapStyle === "roadmap"){
