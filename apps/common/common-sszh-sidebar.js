...
require('/apps/common/common-sszh-sidebar.css');
...
avalon.component('ms-sszh-sidebar', {
    ...
    defaults: {
        ...
        handleCheckJustChoose(event) {
            if (this.isJustChoose) {
                orgTree.hideOrShowChooseNodes(true);
            } else {
                orgTree.hideOrShowChooseNodes(false)
            }
        }
    },
});
...
const orgTree = (function () {
    ...
    function onChecked(event, treeId, treeNode) {
        ...
        if (!treeNode.checked && vm.isJustChoose) {
            hideOrShowChooseNodes(true)
        }
    ...
    function hideOrShowChooseNodes(isHide) {
        let  treeNodes = treeObj.getCheckedNodes(false)
        if ($.type(treeNodes) !== 'array') {
            treeNodes = [treeNodes];
        }
        if (isHide) {
    ...
    return {
        ...
        hideOrShowChooseNodes: hideOrShowChooseNodes,
